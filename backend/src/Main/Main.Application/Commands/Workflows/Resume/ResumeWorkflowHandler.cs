...
internal sealed class ResumeWorkflowHandler(
    IMainDbContext dbContext,
    IUserContext userContext,
    IModelRegistry modelRegistry,
    IWorkflowScheduleService workflowScheduleService,
    IDateTimeProvider dateTimeProvider) : ICommandHandler<ResumeWorkflowCommand>
{
    public async ValueTask<Outcome> Handle(ResumeWorkflowCommand request, CancellationToken cancellationToken)
    {
